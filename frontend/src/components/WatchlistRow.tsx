...
export default function WatchlistRow({
  ...
  return (
    <div className={`group flex items-center gap-4 px-4 py-3 rounded-xl border transition-colors ${
      ...
      <div className="flex-1 min-w-0">
        <p className="text-xs text-slate-400 truncate">{entry.signals?.explanation}</p>
